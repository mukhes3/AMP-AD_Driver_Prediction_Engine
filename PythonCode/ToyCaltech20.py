...
tmp = scio.loadmat('./MultiViewData/Caltech101-20.mat')
X1 = tmp['X'][0][0]
X2 = tmp['X'][0][1]
X3 = tmp['X'][0][2]
...
for i in Classes:
    ...
    d1 = SF.IterativeCotraining(X1,X2,X3,Yi,C1 = C1, C2 = C2, C3= C3, rho=10.0)
    d2 = SF.IterativeCotraining(X1,X2,X3,Yi,C1 = C1, C2 = C2, C3= C3, rho=100.0)
...
df.to_csv('Caltech101-20_results_1228_2.csv')
